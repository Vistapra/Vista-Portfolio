            ...
            <div className="container">
                <div className="container-inner">
                        ...
                        <div className="col-xl-12 col-lg-12">
                            <SlideUp>
                                <div className="section-title text-center">
                                    ...
                                    <p>Dive into my portfolio of innovative projects, thoughtfully developed with precision and expertise. Every creation showcases a unique blend of technical mastery and creative vision that defines my work.</p>
                                </div>
                            </SlideUp>
                        </div>
                    </div>
                    ...
                    <div className="row project-masonry-active overflow-hidden">
                        {filteredProjects.map(({ category, id, src, title, path }) => (
                            <Card
                                key={id}
                                id={id}
                                category={category}
...
const Card = ({ category, title, src, animationClass, id, path }) => {
    return (
            ...
            <SlideUp delay={id}>
                <div className="project-item style-two">
                    <div className="project-image">
                        ...
                        <Link to={path} className="details-btn">
                            <RiArrowRightUpLine />
                        </Link>
                    </div>
