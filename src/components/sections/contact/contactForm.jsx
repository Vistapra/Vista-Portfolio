                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <input type="text" id="name" name="name" className="form-control" value="" placeholder="Vista Pramudya" required="" data-error="Please enter your Name" />
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <input type="email" id="email" name="email" className="form-control" value="" placeholder="vistapramudya@gmail" required="" data-error="Please enter your Email" />
